...
if(num=='1'):
    file = open(file=r'C:\Users\HP VICTUS\OneDrive\Desktop\OpenAiRepo\udemyKuljotOpenAi\lab7\factorial.py', encoding='utf8').read()
    prompt="please debug this code in python \n" + file
    response(azure_key,azure_endpoint,prompt)
    
else:
    file=open(file=r'C:\Users\HP VICTUS\OneDrive\Desktop\OpenAiRepo\udemyKuljotOpenAi\lab7\function.py', encoding='utf8').read()
